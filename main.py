...
def main():
    ...
    optional_args_parser.add_argument("--exact", action="store_true", help="Use the exact algorithm to solve the problem.")
    ...
    optional_args_parser.add_argument("--time_limit", type=int, default=30, help="The time limit (in seconds) for the solver. (Default: 30)")
    ...
    result = solve(graph, vehicles, greedy=args.greedy, exact=args.exact, pricing_strategy=args.pricing_strategy, time_limit=args.time_limit)
